...
!
    ...
    subroutine find_reac
    use mode     ,only: npart,nstep,mlist,molelist,types,ctype,n_mol,dt,ico
    implicit none
...
55        continue
       ...
       write(35,'(A8,F20.4)')'Time(ps): ',nstep*dt
...
!         read(str_name(l),'(4I5)')(nty(j),j=1,4)
          ...
          enddo  
          write(35,'(A20,1X,A1,1X,I8)')mol_name,'x',str_num(l)      
       enddo
